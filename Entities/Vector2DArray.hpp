...
class Vector2DArray {
    ...
    public:
        ...
        static void SetZero(std::vector<astar::Vector2D<T>> &v) {
        ...
        // custom dot product
        static T DotProduct(
                const std::vector<astar::Vector2D<T>> &a, const std::vector<astar::Vector2D<T>> &b)
        {
        ...
        static void ScaleVector(T value, std::vector<astar::Vector2D<T>> &v) {
        ...
        static void AddVectors(const std::vector<astar::Vector2D<T>> &a, std::vector<astar::Vector2D<T>> &b) {
        ...
        // C == A - B
        static void SubtractCAB(std::vector<astar::Vector2D<T>> &c, const std::vector<astar::Vector2D<T>> &a, const std::vector<astar::Vector2D<T>> &b) {
        ...
        static T VectorNorm2(const std::vector<astar::Vector2D<T>> &v) {
        ...
        static bool EqualVectors(const std::vector<astar::State2D> &current, const std::vector<astar::State2D> &next) {
